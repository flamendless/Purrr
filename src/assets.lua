...
function states.menu()
	return {
		images = {
			...
			{ id = "button_erase", path = "assets/gui/button_erase.png" },
			{ id = "button_erase_hovered", path = "assets/gui/button_erase_hovered.png" },
...
function states.lobby()
	return {
		images = {
			...
			{ id = "button_cat_info", path = "assets/gui/button_cat.png" },
			{ id = "button_cat_info_hovered", path = "assets/gui/button_cat_hovered.png" },
